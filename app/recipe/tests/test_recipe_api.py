...
def sample_ingredient(user, name='Cinnamon'):
    """Create and return a sample ingrident"""
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_creat_recipe_with_tags(self):
        ...
        tag1 = sample_tag(user=self.user, name='Fat')
        tag2 = sample_tag(user=self.user, name='Fast Food')
        payload = {
            'title': 'French fries red white',
    ...
    def test_tesr_partial_update_recipe(self):
